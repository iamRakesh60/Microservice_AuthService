...
import com.Microservice_1.client.AuthServiceFegnClient;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private AuthServiceFegnClient authServiceFeignClient;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            UserDto user = authServiceFeignClient.findByUsername(username,authHeader);
